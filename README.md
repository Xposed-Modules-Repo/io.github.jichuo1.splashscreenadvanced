...
**简体中文** · [English](https://github.com/Xposed-Modules-Repo/io.github.jichuo1.splashscreenadvanced/blob/main/README_EN.md)
...
| Alpha 预发布 | 向 `main` 推送，或手动运行 [alpha-release](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/.github/workflows/alpha-release.yml) |
| Stable 发布 | [stable-release](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/.github/workflows/stable-release.yml) |

发布签名使用 GitHub Environment Secrets，密钥库不要放进仓库。步骤见 [release-signing](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/.github/release-signing/README.md)。
...
本项目基于 [GSWXXN/RestoreSplashScreen](https://github.com/GSWXXN/RestoreSplashScreen)（作者 GSWXXN）修改而来。原作品与本仓库均以 [GNU Affero General Public License v3.0](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/LICENSE) 授权。
