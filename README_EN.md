...
<img src="https://raw.githubusercontent.com/jichuo1/SplashScreenAdvanced/main/docs/logo.png" width="96" height="96" alt="SplashScreenAdvanced">
...
[简体中文](https://github.com/Xposed-Modules-Repo/io.github.jichuo1.splashscreenadvanced/blob/main/README.md) · **English**

<br>

[![License](https://img.shields.io/github/license/jichuo1/SplashScreenAdvanced?style=flat-square&color=a32d2a)](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/LICENSE)
...
| Alpha pre-release | Push to `main`, or run [alpha-release](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/.github/workflows/alpha-release.yml) manually |
| Stable release | [stable-release](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/.github/workflows/stable-release.yml) |

Release signing uses GitHub Environment Secrets — never put the keystore in the repository. Steps are in [release-signing](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/.github/release-signing/README.md).
...
This project is based on [GSWXXN/RestoreSplashScreen](https://github.com/GSWXXN/RestoreSplashScreen) by GSWXXN. Both the original work and this repository are licensed under the [GNU Affero General Public License v3.0](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/LICENSE).
...
**[AGPL-3.0](https://github.com/jichuo1/SplashScreenAdvanced/blob/main/LICENSE)** · [Issues](https://github.com/jichuo1/SplashScreenAdvanced/issues) · [Releases](https://github.com/jichuo1/SplashScreenAdvanced/releases)
